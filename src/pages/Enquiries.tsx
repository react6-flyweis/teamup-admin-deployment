      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm font-montserrat text-gray-400 mt-1">
            Manage, review, and reply to messages submitted by customers.
          </p>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <button
                        title="View Details"
                        className="w-8 h-8 rounded-md bg-white border border-[#E9A7CE] hover:border-[#E1017D] text-gray-700 hover:text-[#E1017D] inline-flex items-center justify-center transition"
                      >
                        <EyeIcon size={16} />
                      </button>
                    </td>
